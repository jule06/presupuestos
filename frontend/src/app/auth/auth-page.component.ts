...
@Component({
      ...
      <div class="auth-card">
        ...
        @if (mode !== 'forgot-password') {
          <button class="google-signin-btn" type="button" (click)="signInWithGoogle()" [disabled]="loading">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" style="display:block;flex-shrink:0;">
  ...
  styles: [`
    ...
    @media (max-width: 480px) {
      .auth-bg { align-items: flex-start; padding-top: 32px; }
